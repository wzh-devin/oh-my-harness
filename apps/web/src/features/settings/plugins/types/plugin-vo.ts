...
export interface PluginManifestVo {
  schemaVersion: 1
  format: PluginFormat
  name: string
  displayName: string
...
export interface PluginMarketVo {
  id: string
  name: string
  builtIn: boolean
  format: PluginFormat
...
export interface PluginCatalogVo {
  markets: PluginMarketVo[]
  entries: PluginEntryVo[]
  total: number
  categories: string[]
  updatedAt: string
  error?: string
...
export interface PluginOperationVo {
  id: string
